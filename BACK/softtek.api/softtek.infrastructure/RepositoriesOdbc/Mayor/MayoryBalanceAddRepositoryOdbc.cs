...
{
    public class MayoryBalanceAddRepositoryOdbc : IMayorAddRepository
    {
        private IMapper _mapper;
        private readonly DbTestSofttekContext _dbTestSofttekContext;
        public MayoryBalanceAddRepositoryOdbc(IMapper mapper, DbTestSofttekContext dbTestSofttekContext)
        {
            _mapper = mapper;
